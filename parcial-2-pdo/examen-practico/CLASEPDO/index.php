...
# NOMBRE DEL ALUMNO: JOSE GERARDO SANCHEZ RODRIGUEZ
# GRUPO: 3-3
...
use models\Producto;
    ...
    if (isset($_GET['eliminar'])) {
        ...
        if($controller->eliminar($idEliminar)) {
            $mensaje = "Producto aliminado correctamente.";
        }else {
                    ...
                    <?php if (count($productos) > 0) : ?>
                        <?php foreach ($productos as $producto): ?>
                            <tr>
                                ...
                                <td>$<?php echo number_format($producto['precio'], 2); ?></td> <td>
                                    ...
                                    <a href="index.php?eliminar=<?php echo $producto['id']; ?>" 
                                        ...
                                        onclick="return confirm('¿Seguro que deseas eliminar este producto?');">Eliminar
                                    </a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
