...
* **Encapsulamiento**: Los atributos `$nombre` y `$correo` se definieron como **privados** para proteger la información y evitar que sea alterada directamente desde fuera de la clase.
...
4. **Prueba**: "Las primeras dos lineas muestran los datos antes de usar los setters (ultimas dos lineas) ".
